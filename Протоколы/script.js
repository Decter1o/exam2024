...
function ShowBurgherMenu(){
    if($('.menu-main').hasClass('menu-active')){
        $('.menu-main').removeClass('menu-active');
        $('.burger-menu-button i').attr('class', 'fa-solid fa-bars')
    } else {
        $('.menu-main').addClass('menu-active');
        $('.burger-menu-button i').attr('class', 'fa-solid fa-xmark')
    }
}
